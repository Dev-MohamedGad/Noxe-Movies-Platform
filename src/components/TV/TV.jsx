...
export default function Tv() {
  ...
  async function allTVs() {
    ...
    if (tvResponse?.response?.data?.success === false) {
          ...
          <div className={`row gy-4 mt-3`}>
            ...
            >
              ...
              <p className=" mb-0 text-color">
                A list of all TV Series ,this list is updated every week depends
                on trending TV Series.
              </p>
            </div>

            {tvSeries?.map((tv) => (
              <div key={tv.id} className={`col-lg-2 col-md-4 ${style.poster}`}>
